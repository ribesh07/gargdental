    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-700 text-[15px] mb-6">
          At <strong>Garg Dental</strong>, we only deal in medical and dental
          equipment that meet recognized national and international
          certification standards. We work with manufacturers and importers who
          follow strict regulatory compliance, ensuring that the products we
          deliver are safe, reliable, and approved for clinical use.
        </p>
        ...
        <p className="text-sm text-gray-600">
          ⚠️ Note: Certification may vary depending on the product and
          manufacturer. For specific product compliance, please check the
          product detail page or contact us at{" "}
          <strong>support@gargdental.com</strong>.
        </p>
      </div>
    </div>
  );
