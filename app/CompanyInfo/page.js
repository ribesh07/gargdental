    ...
    <div className="max-w-3xl mx-auto px-6 py-10">
      ...
      {loading ? (
        ...
        <>
          ...
          {files.length > 0 && (
            <div className="mt-6">
              <h2 className="text-lg font-semibold mb-2 text-[#0072bc]">📎 Download Attachments</h2>
          ...
          <div className="mt-8 text-[14px] text-gray-600">
            <p>
              ...
              <a href="/BusinessReg" className="text-blue-600 underline ml-1">Business Registration</a> and 
              <a href="/MedicalCertification" className="text-blue-600 underline ml-1">Medical Certifications</a>.
            </p>
          </div>
        </>
      )}
