    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">No Transaction ID</h1>
          <p className="text-gray-600 mb-8">Unable to process the payment verification.</p>
          <Link 
            href='/' 
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4">
        <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 px-8 py-6">
            ...
            <p className="text-green-100 text-center">Your transaction has been completed successfully</p>
          </div>
          ...
          <div className="px-8 py-6">
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <div className="flex justify-between items-start py-2">
                ...
                <span className="text-red-600 font-medium text-right text-sm">{result.statusDesc}</span>
              </div>
            </div>
          ...
          <div className="px-8 py-6">
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <div className="flex justify-between items-start py-2">
                ...
                <span className="text-red-600 font-medium text-right text-sm">FAILED TO VALIDATE </span>
              </div>
            </div>
