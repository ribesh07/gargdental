...
export function BuyNow({ product }) {
  ...
  return (
    <button
      onClick={handleAdd}
      // disabled={added}
      className="btn py-1 mt-1 mb-1 sm:py-2 bg-blue-600 hover:bg-red-600 text-white w-full px-1 rounded-md font-medium flex items-center justify-center space-x-1 sm:space-x-2 transition-colors duration-200 text-xs sm:text-sm"
    >
